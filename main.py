...
def student_attendance():
    messagebox.showinfo("Student Page", "Redirecting to the Attendance Page...")
...
tk.Button(window, text="Login as Student", width=25, font=("Arial", 12), bg="#28A745", fg="white",
          command=student_attendance).pack(pady=10)
...
frame1 = tk.Frame(window, bg="#ece9f0")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#ece9f0")
